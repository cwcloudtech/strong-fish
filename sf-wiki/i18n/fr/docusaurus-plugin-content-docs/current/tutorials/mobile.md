...
L'application mobile peut être connectée en [scannant le QR code d'une clé d'API](./api.md#api-keys) plutôt qu'en tapant un e-mail et un mot de passe sur un clavier de téléphone.

## Android

Il n'y a pas encore de version sur le Google Play Store, mais vous pouvez télécharger et installer l'application Android directement, en cliquant sur _Télécharger l'app Android_ dans le menu.

![android-download](../../../../../static/img/screenshots/android-download.png)

Sur un ordinateur, un QR code s'affiche pour que vous le scanniez avec votre téléphone ; sur un téléphone, le téléchargement démarre directement.
...
Cette section s'adresse à qui construit et distribue le build. Si vous voulez
